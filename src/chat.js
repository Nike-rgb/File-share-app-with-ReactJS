    ...
    <>
        ...
        <IconButton>
          <FiberManualRecordIcon
            style={{
              ...
              width: 14,
              fill:
                activeStatus === "Offline" ? "#efeeee82" : "rgb(136 210 130)",
            }}
          />
        </IconButton>
      </Tooltip>
      <Tooltip
        title={unreadMsgs ? `${unreadMsgs}  unread msgs` : "No new msgs"}
      >
      ...
      >
        ...
        <div className={classes.chatContainer}>
              ...
              return (
                <div
                  ...
                  className={`msg-container ${
                    msgObj.type === "sent" ? "myMsg" : "hisMsg"
                  }`}
                >
                  <span className="msg">{msgObj.msg}</span>
                </div>
              );
            })}
          </div>
          ...
          >
            Notification sound from{" "}
            <a href="https://notificationsounds.com/">Notification Sounds</a>
          </p>
        </div>
      </Menu>
    </>
