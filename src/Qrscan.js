...
const useStyles = makeStyles((theme) => ({
  ...
  export default function QrScan(props) {
    ...
    return (
        ...
        <Backdrop classes={{root : classes.backdrop}} open={true} onClick={() => props.setScannerOpen(false)}>
          <div style={{width:250, height:250, position:'relative', border:'3px solid white'}}>
            <div style={{
              position: 'absolute',
              width: '100%',
              height: '100%',
